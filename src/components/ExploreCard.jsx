  ...
  >
    ...
    {active !== id ? (
      ...
      <div dir='rtl' className="absolute lg:bottom-[-40px] lg:p-10 md:p-10 p-10 flex justify-start w-full flex-col rounded-b-[24px]" >
        <h2 className="lg:w-96 text-left lg:mr-48 md:mr-40 mr-10 lg:text-5xl md:text-6xl text-3xl text-white" id='group2heading'>
          {title}
        </h2>
        <div dir='rtl'
        ...
        >
          ...
          <img
            src={img}
            alt="headset"
            className="object-contain lg:mx-0 -mx-10 lg:mb-56 md:mb-20 mb-40 lg:w-[100%] md:w-[150px] w-[100px]"
          />
        </div>
