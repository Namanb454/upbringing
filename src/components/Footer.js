                ...
                <div className='w-full lg:mt-10 mt-10 lg:pb-5 pb-5'>
                    ...
                    <div className='lg:flex'>
                        ...
                        <span className="flex lg:ml-auto lg:mt- mt- lg:mx-20  w-full justify-center md:w-auto">
                            ...
                            <a href='/' className="my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="100">
                            ...
                            <a href='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="300">
                            ...
                            <a href='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="500">
                            ...
                            <a href='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="700">
