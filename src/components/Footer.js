                ...
                <div className='w-[100%] lg:mt-10 mt-10 lg:pb-5 pb-5'>
                    ...
                    <div className='lg:flex'>
                        ...
                        <span className="flex lg:ml-auto lg:mt- mt- lg:mx-20  w-[100%] justify-center md:w-auto">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out" data-aos-duration="500">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out" data-aos-duration="700">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out" data-aos-duration="900">
