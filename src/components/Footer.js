        ...
        <div>
            <footer className="text-gray-600 body-font" id='footer'>
                ...
                <div className='w-full lg:mt-10 mt-10 lg:pb-5 pb-5'>
                    ...
                    <div className='lg:flex'>
                        ...
                        <span className="flex lg:ml-auto lg:mt- mt- lg:mx-20  w-full justify-center md:w-auto">
                            ...
                            <Link to='/' className="my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="100">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="300">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="500">
                            ...
                            <Link to='/' className="ml-3 my-auto mx-2 p-2 rounded-full bg-black" data-aos="zoom-out-left" data-aos-duration="700">
                ...
                <p className="text-gray-500 pb-7 lg:pt-0 pt-2 text-sm text-center">© 2023
                    <Link to="/" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@UpBringing</Link>
                </p>
